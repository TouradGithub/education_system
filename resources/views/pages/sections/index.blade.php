            ...
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="create-form pt-3" id="formdata" action="{{ route('web.sections.store')}}" method="POST" novalidate="novalidate">
                            @csrf
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <table aria-describedby="mydesc" class='table' id='table_list' data-toggle="table"
                                        data-url="{{ url('sections-list') }}" data-click-to-select="true"
    ...
    <div class="modal fade" id="editModal" data-backdrop="static" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form id="formdata" class="editform" action="{{url('update-section-list')}}" novalidate="novalidate">
                    @csrf
