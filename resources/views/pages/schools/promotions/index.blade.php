            ...
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                   ...
                   <th scope="col" data-field="from_section_id" data-sortable="true" >
                    ...
                    <th scope="col" data-field="to_section_id" data-sortable="false">{{ __('promotion.to_section') }}
                    </th>
                    <th scope="col" data-field="academic_year" data-sortable="false">
                        {{ __('promotion.academic_year') }}</th>

                    <th scope="col" data-field="academic_year_new" data-sortable="true" >{{ __('promotion.academic_year_new') }}</th>
