                        ...
                        <form class="pt-3" id="admin-profile-update" enctype="multipart/form-data"
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-sm-12 col-md-6">
                                    ...
                                    {!! Form::text('name', "$admin_data->first_name", [
                                ...
                                <div class="form-group col-sm-12 col-md-6">
                                    ...
                                    {!! Form::text('phone', "$admin_data->mobile", ['placeholder' => __('genirale.mobile'), 'class' => 'form-control']) !!}
                                </div>
                                ...
                                <div class="nav-profile-img">
                                    <img style="width: 80px;height: 80px;border-radius: 20%" src="{{url(Storage::url($admin_data->image))}}" alt="image" onerror="onErrorImage(event)">
                               </div>
