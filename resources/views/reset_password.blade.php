...
<div class="content-wrapper">
    ...
    <div class="row grid-margin">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <form id="formdata" class="create-form password_form" action="{{ route('web.changePassword') }}"
                    method="POST" novalidate="novalidate">
                    @csrf
                    <div class="row">
                        <div class="form-group col-md-6 col-sm-10">
                            <label>{{ __('genirale.old_password') }}</label>
                            <div class="input-group">
                                <input type="password" name="old_password" id="old_password" required
                                placeholder="{{ __('genirale.old_password') }}" class="form-control" />
                    ...
                    <div class="row">
                        <div class="form-group col-md-6 col-sm-10">
                            <label>{{ __('genirale.new_password') }}</label>
                            <div class="input-group">
                                <input type="password" name="new_password" id="new_password" required
                                placeholder="{{ __('genirale.new_password') }}" class="form-control" />
                                <div class="input-group-append">
                                    <span class="input-group-text">
                    ...
                    <div class="row">
                        <div class="form-group col-md-6 col-sm-10">
                            <label>{{ __('genirale.confirm_password') }}</label>
                            <div class="input-group">
                                <input type="password" name="confirm_password" id="confirm_password" required
                                placeholder="{{ __('genirale.confirm_password') }}" class="form-control" />
                                <div class="input-group-append">
                                    <span class="input-group-text">
